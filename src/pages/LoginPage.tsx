...
export function LoginPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-white flex flex-col p-6">
      {/* Header Image / Pattern could go here */}
      <div className="flex-1 flex flex-col justify-center">
        <div className="mb-10">
          ...
          <h1 className="text-[26px] font-semibold text-[#181725] mb-2">Loging</h1>
          <p className="text-[#7C7C7C] text-base">Enter your emails and password</p>
        </div>
