  ...
  return (
    <div className="min-h-[100dvh] bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center p-6 mt-4">
        <div className="w-48 h-48 mb-10 opacity-70">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-6">
          <div className="flex flex-col gap-2 relative">
            <label className="text-sm font-semibold text-[#7C7C7C]">Your Zone</label>
            <select 
              value={zone}
          ...
          <div className="flex flex-col gap-2 relative">
            <label className="text-sm font-semibold text-[#7C7C7C]">Your Area</label>
            <select 
              value={area}
          ...
          <Button type="submit" fullWidth className="mt-8 py-5">
            Submit
          </Button>
        </form>
      </div>
